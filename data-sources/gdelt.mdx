---
title: "GDELT Cloud v2 Conflict Events Ingestion"
sidebarTitle: "GDELT"
description: "How GeoSentinel ingests GDELT Cloud v2 conflict events: polling interval, CAMEO code mapping, deduplication by globalEventId, and the Bearer token auth."
---
...
| Events endpoint | `GET /api/v2/events` |
...
```python
event_id_source = str(event.get("id", ""))  # e.g. "gdelt_ev_abc123"
```
