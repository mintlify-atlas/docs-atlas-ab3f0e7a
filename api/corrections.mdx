...
description: "POST /v1/corrections lets operators mark false positives, close, reclassify, relocate, or merge incidents. Every correction is recorded in an audit trail."
---
