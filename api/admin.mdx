...
sidebarTitle: "Admin"
description: "Background job API for GeoSentinel ingestors and lifecycle maintenance. POST to trigger jobs, GET to poll status. Returns 409 on duplicate runs."
---
